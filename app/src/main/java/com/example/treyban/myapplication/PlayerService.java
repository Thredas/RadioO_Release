...
import com.example.treyban.searchActivity;
...
final public class PlayerService extends Service {
    ...
    public static String name_author=null;
    public static String name_stream=null;
    public static Bitmap bitmap=null;
    public static boolean stateN= Boolean.parseBoolean(null);
    //private final MusicRepository musicRepository = new MusicRepository();
    public  void setData_Media(String name,String name_stream, String name_author, String stream, Bitmap bitmap){
        PlayerService.name =name;
        PlayerService.stream =stream;
        PlayerService.name_author =name_author;
        PlayerService.name_stream =name_stream;
        PlayerService.bitmap =bitmap;
    }
    ...
    public void onCreate() {
        ...
        Intent activityIntent = new Intent(appContext, MainActivity.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
...
//            new searchActivity().state_now_music_symbol();
        ...
        private void prepareToPlay(Uri uri) {
            if (!uri.equals(currentUri)) {
                currentUri = uri;
                Log.d("!!!!!!!!!!!!!!!!!!!!!!!!!!!!jhjhjhjhjhjhjhjhjhjhjhjhjhjhhjjhjhjhj!!!!!!!!!!!!!", String.valueOf(uri));
                Log.d("!!!!!!!!!!!!!!!!!!!!!!!!!!!!jhjhjhjhjhjhjhjhjhjhjhjhjhjhhjjhjhjhj!!!!!!!!!!!!!", String.valueOf(currentUri));
        ...
        void updateMetadataFromTrack(String name, String name_stream, String name_ispoln, Bitmap bt) {
            metadataBuilder.putBitmap(MediaMetadataCompat.METADATA_KEY_ART,bt );
            metadataBuilder.putString(MediaMetadataCompat.METADATA_KEY_TITLE, name_stream);
            metadataBuilder.putString(MediaMetadataCompat.METADATA_KEY_ALBUM, name);
            metadataBuilder.putString(MediaMetadataCompat.METADATA_KEY_ARTIST, name_ispoln);
    ...
    private Notification getNotification(int playbackState) {
        ...
        builder.addAction(new NotificationCompat.Action(R.drawable.ic_skip_previous, getString(R.string.previous), MediaButtonReceiver.buildMediaButtonPendingIntent(this, PlaybackStateCompat.ACTION_SKIP_TO_PREVIOUS)));
        ...
        builder.addAction(new NotificationCompat.Action(R.drawable.ic_skip_next, getString(R.string.next), MediaButtonReceiver.buildMediaButtonPendingIntent(this, PlaybackStateCompat.ACTION_SKIP_TO_NEXT)));
